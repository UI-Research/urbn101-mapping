...
* **<font color="#ec008b"> Free and open source! </font>** We are lucky and have great access to software at Urban- but outside of work, it can be expensive (financially and computationally!) to get other GIS software.
...
<font color="#55b748">**Step 2:**</font> Type `View(data)` into the console.

<font color="#55b748">**Step 3:**</font> Type the following code into your script.

```
states <- get_urbn_map(map = "states", sf = TRUE)
```

Type `View(states)` into the console.

<font color="#55b748">**Step 4:**</font> Merge the dataset with the geographic data using `left_join()`. Make sure that the geographic data is on the left side of the join.
