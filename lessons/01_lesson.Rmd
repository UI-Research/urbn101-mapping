...
<font color="#55b748">**Step 8:**</font> Write `library(tidyverse)`, `library(urbnmapr)`,  `library(urbnthemes)`, and `library(ggplot2)` at the top of `01_intro-to-mapping.R`. With the cursor on the line of text, click Control-Enter.
...
<font color="#55b748">**Step 4:**</font> Add the line `scale_fill_gradient(labels = scales::dollar)` to the map. What changed?
