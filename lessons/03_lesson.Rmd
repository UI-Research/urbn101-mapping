...
When we are working with spatial data, we sometimes want to create buffers around certain geographies. For instance, maybe you want to find all the houses that are within half a mile from a bus station. `st_buffer()` is a helpful function for creating buffers around points, lines or polygons.
