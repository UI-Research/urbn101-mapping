...
## Exercise 6: What are coordinate reference systems?
...
## Exercise 7: Transforming CRS's

<font color="#55b748">**Step 1:**</font> Open the zoning_districts.prj file, copy the contents and use [http://prj2epsg.org](http://prj2epsg.org) to determine the relevant `EPSG` code. 


<font color="#55b748">**Step 2:**</font> Confirm that SF used the correct EPSG code when it read in the shapefile by using `st_crs()` on the `tor_zones` dataframe.  

<font color="#55b748">**Step 3:**</font>  Use [epsg.io](https://epsg.io) to find out what the units of this CRS is. 

<font color="#55b748">**Step 4:**</font> The actual coordinates of this coordinate system may look foreign to people used to lat/lons. So transform the CRS to 4326 to get latitude/longitude. 
